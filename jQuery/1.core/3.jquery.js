...
$('.myClass') //jquery에서 만든 collection을 return받는다.
...
$('ul li').filter('.current') // li 값 리턴 , filtering = true를 찾는과정
/* 
<ul>
    <li class='current'></li>
    <li></li>
...
$('form :input') // input 태그를 두루 묶어서 selector, 몽땅찾아서 비활성화할수도 있다(user가 데이터를 입력하지못하도록)
/*
<input type='text'/>
<textarea></textarea>
<select></select>
