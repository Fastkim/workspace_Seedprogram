...
public interface Electronic { // instance를 만들지 않기때문에 instance variable이 존재할 수 없다.
	public static final int VOLTAGE  = 200;  // static variable은 VM이 바이트코드를 로딩될때 생성, final : 상수
	static final String MAKER_NAME = "LG"; // public을 생략해도 cmpiler가 넣어줍니다.
	final int WEIGHT = 10; // static을 생략해도 compiler가 넣어줍니다.
