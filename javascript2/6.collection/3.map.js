...
map.set('1', 'hello') //map.set(key, value), write 과정
...
//
map = new Map()
map.set(1, 'amella').set(2, 'every').set(3, 'adela') // Map<any, any> : key, value 어떤것이 와도된다는 의미. map chaning
console.log(map)
...
greens.forEach((val, key) => console.log(key, val)) // best way
