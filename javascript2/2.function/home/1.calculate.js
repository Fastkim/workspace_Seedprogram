...
console.log(calculate(1,2,multiplication))
...
/* let calculate = function(number1, number2, operator='*') { //유사한 코드가 반복될 때는 for문보다 case문이 더 가독성이 좋다.
    let result
