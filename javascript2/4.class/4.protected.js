...
CoffeeMachine = class {
    ...
    get waterAmount() {  // getter
        return this._waterAmount + 100 // +waterAmount variable을 읽을때 사용하는 메서드, 이런식으로 보안을 위해 메서드로 variable을
                                       // read,write를 하는걸 캡슐화라고 한다.
    }

    set waterAmount(waterAmount) { // setter
        this._waterAmount = 2 * waterAmount // _waterAmount variable을 쓸 때 사용하는 메서드
    }
}
...
// variable에 할당연산자로 value가 부여되면 node.js가 set 메서드를 작동시킨다.
