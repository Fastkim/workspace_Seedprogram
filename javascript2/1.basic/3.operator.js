...
// Unary plus operator
console.log(1 + +'2') // String앞에 '+'연산자를 써넣으면 String을 넘버타입으로 변환

/** logical */
console.log(1 || 0, 0 || 1) // ||(빠른 or) -> or
console.log(1 && 0, 0 && 1) // &&(빠른 and) -> and
console.log(1 && 2, 2 && 1) // parsing이 어디까지 진행되느냐의 차이 and 연산이기때문에 첫 false를 발견할때까지 연산.

//foo && do(foo) // 데이터가 들어있지않는 상태의 foo (underfined(foo) -> false), 데이터가 있으면 (true -> do APU를 실행 )
...
console.log()
console.log('2' > 1, '01' == 1, false == 0, '0' == 0, '' == false) // 형변환 우선순위 number > String==bolean
console.log(true > 1)
...
console.log('z' > 'a', 'ac' > 'ab', 'bee' > 'be', 'a' > 'A') //유니코드
