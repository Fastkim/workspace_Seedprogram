...
public class C02Output {
	public static void main(String[] args) {
		...
		System.out.println(Math.random());  // 0.0 이상 1.0 미만, double 타입 리턴
		
		System.out.print(200); // api : 공개되s library를 의미한다.
		System.out.print(300); // print : 줄바꿈이 없음.
		System.out.print('\n'); // single quotation : '' = char , double quotation : "" = string
		System.out.print(400);
		System.out.println(); // 한줄 띄우기
		
		System.out.printf("%b %c %d %f %s\n", true, 97, 10, 1.15, "hello"); //print(printformat), space로 구분한 상태
		// 과제: 위 출력문에서 구분자로 '/'를 사용하라.
		System.out.printf("%b/%c/%d/%f/%s\n", true, 97, 10, 1.15, "hello");
