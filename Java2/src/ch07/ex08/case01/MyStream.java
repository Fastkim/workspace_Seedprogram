...
public class MyStream {
	public static void main(String[] args) {
		...
		// 노동자ID : ++, 또는 stream을 쓸 수 있다.
		// for문 대신 stream 활용
		
		IntStream stream2 = IntStream.range(1, 4); // 1이상 4미만, Integer stream 생성
		stream2 = "abc".chars(); // 문자열을 유니코드값으로 return 해주는 메서드
		
		Stream<String> stream3 = Pattern.compile(",").splitAsStream("cat,dog,lion"); // 문자열을 받아서 ,로 구분짓는다, String 스트림 생성
