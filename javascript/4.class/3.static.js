class Article {
    static publisher = 'ddanzi'    // 클래스안에 있는 variable을 member variable이라고 한다.
    ...
    toString() { // instance method : 객체를 생성해야 사용할 수 있는 메서드
        return this.title // String 타입으로 casting 할때 사용
    }
...
Article.getPrice = () => 2000 // static으로 멤버메서드를 할당한것이다. static => 클래스라는 접두사로 바로 메서드나 변수를 할당하거나 호출할수있다.
...
console.log(article1 + '') // + '' : 0으로 casting 된것이다.
